...
В этот проект добавлены расширенные возможности анализа транзакций, включая:
#### Чтение данных из различных форматов файлов
Поддерживается чтение данных о транзакциях из файлов JSON, CSV и Excel (XLSX).
#### Фильтрация транзакций
Позволяет фильтровать транзакции по статусу (например, EXECUTED, CANCELED).
#### Сортировка транзакций
Позволяет сортировать транзакции по дате, по возрастанию или убыванию.
#### Фильтрация по валюте
Фильтрует транзакции, чтобы отображать только те, которые выполнены в определенной валюте (например, RUB).
#### Фильтрация по описанию
Фильтрует транзакции на основе определенного слова или фразы в описании.
#### Маскировка конфиденциальной информации
Маскирует номера счетов и номера карт в выходных данных для обеспечения конфиденциальности.
